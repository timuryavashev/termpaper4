...
from mailing.views import (HomeView, MessageCreateView, MessageDeleteView, MessageDetailView, MessageListView,
                           MessageUpdateView, SendAttemptListView, SendingCreateView, SendingDeleteView,
                           SendingDetailView, SendingListView, SendingUpdateView, SendMessageView,
                           SubscriberCreateView, SubscriberDeleteView, SubscriberDetailView, SubscriberListView,
